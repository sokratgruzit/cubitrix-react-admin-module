  ...
  const coinCards = [
    {
      ...
      type: 'coin',
      currency: "Atar",
      balance: cardData?.accounts?.main?.totalBalance,
      ...
      incoming: "0",
      outcoming:  cardData?.withdrawals?.atr ? cardData?.withdrawals?.atr : " 0 ",
      customStyles: {},
    },
    {
      id: 2,
      type: "coin",
      currency: "USDC",
      balance: cardData?.accounts?.main?.totalUsdc,
      icon: (
      ...
      incoming: "0",
      outcoming: cardData?.withdrawals?.usdc ? cardData?.withdrawals?.usdc : " 0 ",
      customStyles: {},
    },
    {
      id: 3,
      type: "coin",
      currency: "Eth",
      balance: cardData?.accounts?.main?.totalEth,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      incoming: "0",
      outcoming: cardData?.withdrawals?.eth ? cardData?.withdrawals?.eth : " 0 ",
      customStyles: {},
    },
    {
      id: 4,
      type: 'coin',
      currency: "BTC",
      balance: cardData?.accounts?.main?.totalBtc,
      ...
      incoming: "0",
      outcoming: cardData?.withdrawals?.btc ? cardData?.withdrawals?.btc : " 0 ",
      customStyles: {},
    },
    {
      id: 5,
      type: 'coin',
      currency: "gold",
      balance: cardData?.accounts?.main?.totalGold,
      icon: <svg
      ...
      incoming: "0",
      outcoming: cardData?.withdrawals?.gold ? cardData?.withdrawals?.gold : " 0 ",
      customStyles: {},
    },
    {
      id: 6,
      type: 'coin',
      currency: "platinum",
      balance: cardData?.accounts?.main?.totalPlatinum,
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      incoming: "0",
      outcoming: cardData?.withdrawals?.platinum ? cardData?.withdrawals?.platinum : " 0 ",
      customStyles: {},
    },
  ];
